...
export class EmailService {
  ...
  constructor(private httpClient: HttpClient) {
   ...
   sendEmail(email: Email): Observable<Email> {
      ...
      return this.httpClient.post<Email>("https://13.126.73.190:8092/email/api/v1/email/", email, this.httpOptions);
   }
   getEmailId(userName: string): Observable<string> {
    //  return this.httpClient.get("http://localhost:8092/userreg/api/auth/email/" + userName, {responseType: 'text'});
     return this.httpClient.get("https://13.126.73.190:8092/userreg/api/auth/email/" + userName, {responseType: 'text'});
   }
}
