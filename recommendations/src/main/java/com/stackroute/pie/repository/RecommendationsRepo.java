...
public interface RecommendationsRepo extends Neo4jRepository<Insured,Long> {
    ...
    Insured newInsured(@Param("insuredId")int insuredId,@Param("username")String username, @Param("gender")String gender,@Param("age")int age,@Param("existingDisease")String existingDisease,@Param("numberOfDependants")int numberOfDependants );
    ...
    FamilyMembers newFamilyMembers(@Param("username")String username,@Param("memberName")String memberName,@Param("memberAge")int memberAge,@Param("relation")String relation,@Param("memberGender")String memberGender);
    ...
    Policy updatePolicy(@Param("policyId")int policyId, @Param("insurerName")String insurerName, @Param("policyName")String policyName, @Param("minAge")int minAge, @Param("maxAge")int maxAge, @Param("gender")String gender, @Param("diseases")List<String> diseases, @Param("policyType")String policyType);

    @Query("MATCH (n:Insured{insuredId})")
    Insured updateInsured(@Param("insuredId")int insuredId,@Param("username")String username, @Param("gender")String gender,@Param("age")int age,@Param("existingDisease")String existingDisease,@Param("numberOfDependants")int numberOfDependants );
    ...
    List<Policy> findByAgeGenderDisease(@Param("age")int age,@Param("gender")String gender,@Param("existingDisease")String existingDisease);
